...
function Dashboard() {
  ...
  return (
        <>
        <motion.div className='h-screen w-full bg-black/70 mt-20 relative animate' initial={{ opacity: 0, x: -200, y: -100 }} whileInView={{ opacity: 1, x: 0, y:0 }} transition={{ duration: 0.7, ease: "easeOut" }} viewport={{ once: false, amount: 0.2 }}>
                ...
                <div className="text-7xl font-bold text-center pt-30 bg-gradient-to-bl from-[#5c5c5c] via-[#7e7e7e] to-[#0b0b0b] bg-clip-text text-transparent whitespace-nowrap transition-all duration-200 hover:to-pink-400 hover:via-yellow-400 hover:from-blue-400 hover:scale-102 cursor-pointer animate-pulse">{heading}</div>
        ...
        <motion.div className='min-h-screen w-full bg-black/80 flex flex-col md:flex-row justify-between animate' initial={{ opacity: 0, x: -100 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, ease: "easeOut" }} viewport={{ once: false, amount: 0.2 }}>
